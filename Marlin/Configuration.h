...
#define STRING_CONFIG_H_AUTHOR "(Allen McAfee)" // Who made the changes./robo
...
#define HEATER_0_MAXTEMP 280    //robo
...
#define HOMING_FEEDRATE {50*60, 50*60, 10*60, 0}  // set the homing speeds (mm/min) //robo

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,800,723.38} // default steps per unit for RoBo 3D R1 (Z is 800 for R1+ and 2560 for R1 with 8mm Rod)
...
#define DEFAULT_ENCODER_STEPS_PER_MENU_ITEM 5
